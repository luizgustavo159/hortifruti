...
- Frontend: padronização de feedback/loading estendida para estoque e admin/perfil; smoke test valida carregamento do utilitário compartilhado.
- Frontend: fluxo de caixa (finalização de venda) também passou a usar o utilitário compartilhado de feedback/loading.
